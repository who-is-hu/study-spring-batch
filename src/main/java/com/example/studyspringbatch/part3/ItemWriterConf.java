...
public class ItemWriterConf {
	...
	public ItemWriterConf(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, DataSource dataSource) {
...
//			.processor()
	...
	private List<Person> getItems(){
		...
		for(int i=0; i<100; i++){
			items.add(new Person(i+1, "test name" + i, "age", "test adr" + i));
		}
