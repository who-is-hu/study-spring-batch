...
public class PartitionUserConfig {
	...
	public PartitionUserConfig(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, UserRepository userRepository, EntityManagerFactory entityManagerFactory, DataSource dataSource, TaskExecutor taskExecutor) {
	...
	public Job userGradeUpgradeJob() throws Exception {
		return jobBuilderFactory.get(JOB_NAME)
			...
			.next(this.userLevelupManagerStep()) // master
	...
	public Step userLevelupManagerStep() throws Exception {
		return stepBuilderFactory.get(JOB_NAME + "userLevelUpStep")
			.partitioner(JOB_NAME+"userlevelup", new UserLevelupPartitioner(userRepository))
